...
class LayaLabConfig:
    ...
    def mode_settings(self) -> dict[str, int]:
        # Attention transfer needs to see at least roughly one pass over the
        # question-level sequences.  The old balanced run used only 160x3
        # optimization examples, which is far below the number of decision
        # sequences produced by 160 typed-decision cases.
